                        ...
                        <ul className="list-unstyled components">
                            ...
                            <li className="dash_active">
                                <a href="http://localhost:3000/answered-question">
                                    ...
                                    <span className="badge side_ans_notification">4</span>
                                </a>
                            </li>
                            <li>
                                ...
                                <table className="table table-bordered table-responsive ex_table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Kharif</td>
                                            <td>
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi commodi molestias blanditiis unde hic fugiat.
                                            </td>
                                            <td>12/06/2018</td>
                                            <td>15/06/2018</td>
                                        </tr>
